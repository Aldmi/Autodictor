...
namespace MainExample
{
    ...
    public partial class MainWindowForm : Form
    {
        ...
        public static void ВоспроизвестиШаблонОповещения(string названиеСообщения, SoundRecord Record, СостояниеФормируемогоСообщенияИШаблон формируемоеСообщение, ТипСообщения типСообщения)
        {
            ...
            //DEBUG------------------------
            //PriorityPrecise приоритетВторостепенный= PriorityPrecise.One;
            //switch (Record.НомерПоезда)
            //{
            //    case "086":
            //        приоритетВторостепенный= PriorityPrecise.One;
            //        break;
            ...
            //    case "187":
            //        приоритетВторостепенный = PriorityPrecise.Nine;
            //        break;
            //}
            //----------------------------
