...
namespace MainExample
{
    ...
    public partial class MainWindowForm : Form
    {
        ...
        public static void ВоспроизвестиШаблонОповещения(string ТипСообщения, SoundRecord Record, СостояниеФормируемогоСообщенияИШаблон формируемоеСообщение)
        {
            ...
            Program.ЗаписьЛога(ТипСообщения, $"Формирование звукового сообщения для поезда \"№{логНомерПоезда}  {логНазваниеПоезда}\": " + logMessage + ". Повтор " + Record.КоличествоПовторений + " раз.");
        }
