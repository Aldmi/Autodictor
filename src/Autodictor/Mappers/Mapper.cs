    ...
    public static class Mapper
    {
        ...
        public static SoundRecordDb MapSoundRecord2SoundRecordDb(SoundRecord data)
        {
            return new SoundRecordDb
            {
                ...
                ДниСледованияAlias = data.ДниСледованияAlias,
                ...
                НазваниеПоезда = data.НазваниеПоезда,
                НазванияТабло = data.НазванияТабло,
                Направление = data.Направление,
                НомерПоезда = data.НомерПоезда,
                НомерПоезда2 = data.НомерПоезда2,
                НомерПути = data.НомерПути,
                НомерПутиБезАвтосброса = data.НомерПутиБезАвтосброса,
                ...
                СтанцияНазначения = data.СтанцияНазначения,
                СтанцияОтправления = data.СтанцияОтправления,
